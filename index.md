---
layout: default
title: "قرطاسیه علی اکبری"
description: "خدمات چاپ، کتاب‌فروشی، لوازم تحریر و آموزش دیجیتال در کابل. کیفیت بالا، قیمت منصفانه."
...
<section class="home-advantages">
    <div class="home-container">
        <div class="home-section-header">
            <h2 style="color: white;">چرا ما را انتخاب کنید</h2>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3288.709757336822!2d69.091748!3d34.484886499999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38d1675b0c4497ad%3A0xc6bbf19cf3d81fcd!2z2YLYsdi32KfYs9uM2Ycg2YHYsdmI2LTbjCDZiCDZhdi32KjYudmHINi52YTbjCDYp9qp2KjYsduM!5e0!3m2!1sen!2s!4v1777446844767!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </div>
</section>
...
<section class="home-content-section" style="padding: 80px 0; background: #fff;">
    <div class="home-container">
        <div class="home-section-header">
            <h2>درباره قرطاسیه و خدمات کامپیوتری علی اکبری</h2>
            <p>ارائه دهنده جامع‌ترین خدمات چاپ، کتاب و لوازم تحریر در کابل</p>
        </div>
        <div style="max-width: 900px; margin: 0 auto; line-height: 2; color: #4b5563;">
            <p style="margin-bottom: 20px;">
                <strong>قرطاسیه علی اکبری</strong> در قلب کابل، ناحیه ۶، شهرک ۱۲ واقع شده است. ما با بیش از ده سال تجربه در ارائه خدمات چاپ، کتاب‌فروشی و لوازم تحریر، به یکی از معتبرترین مراکز خدماتی در کابل تبدیل شده‌ایم. تیم متخصص ما با استفاده از مدرن‌ترین تجهیزات چاپ و کپی، خدمات با کیفیت بالا را به مشتریان عزیز ارائه می‌دهد.
            </p>
            <p style="margin-bottom: 20px;">
                در <strong>مطبعه علی اکبری</strong>، ما خدمات متنوعی از جمله <strong>پرینت و کپی</strong> با کیفیت بالا، <strong>چاپ کارت عروسی</strong> و دعوت‌نامه‌های اختصاصی، <strong>چاپ کارت PVC</strong> و کاپی استخوانی، <strong>لمینت اسناد</strong> و اسکن دیجیتال را ارائه می‌دهیم. همچنین خدمات <strong>ترجمه اسناد</strong> به多种 زبان از جمله فارسی، انگلیسی و پشتو از دیگر خدمات تخصصی ماست.
            </p>
            <p style="margin-bottom: 20px;">
                بخش <strong>کتاب‌فروشی</strong> ما شامل انواع کتاب‌های درسی برای تمام مقاطع تحصیلی، کتاب‌های دانشگاهی، کتاب‌های زبان انگلیسی با بهترین قیمت، کتاب‌های آمادگی کانکور و آزمون‌های ورودی، و همچنین کتاب‌های الکترونیکی می‌باشد. ما با تأمین‌کنندگان معتبر همکاری می‌کنیم تا بهترین کتاب‌ها را با قیمت مناسب به مشتریان عرضه کنیم.
            </p>
            <p style="margin-bottom: 20px;">
                در بخش <strong>لوازم تحریر</strong>، انواع خودکار، مداد، پاک‌کن، دفتر، کتابچه، کلاسور، لوازم هنری و رنگی، لوازم اداری و غیره را با تنوع بالا و قیمت مناسب ارائه می‌دهیم. همچنین خدمات <strong>عکاسی حرفه‌ای</strong> شامل عکس پاسپورت، ویزا و اسناد، <strong>بازسازی عکس‌های کهنه</strong> و <strong>ادیت عکس</strong> سفارشی از دیگر خدمات ماست.
            </p>
            <p style="margin-bottom: 20px;">
                برای علاقه‌مندان به یادگیری، ما <strong>بسته‌های آموزشی کامپیوتر</strong> شامل آموزش ICDL، ورد، اکسل، پاورپوینت و برنامه‌نویسی را بر روی فلش مموری عرضه می‌کنیم. همچنین <strong>آموزش زبان انگلیسی</strong> از مبتدی تا پیشرفته، <strong>آموزش هوش مصنوعی</strong> و <strong>آموزش کارآفرینی</strong> از دیگر دوره‌های آموزشی ماست.
            </p>
            <p style="margin-bottom: 20px;">
                از دیگر خدمات تخصصی می‌توان به <strong>طراحی وب‌سایت</strong>، <strong>ویرایش ویدئو</strong> و <strong>نصب نرم‌افزار</strong> اشاره کرد. ما با قیمت منصفانه، کیفیت تضمینی و تحویل سریع در خدمت شما هستیم. برای اطلاعات بیشتر و مشاوره رایگان با ما تماس بگیرید.
            </p>
            <div style="margin-top: 30px; padding: 20px; background: #f0f7ff; border-radius: 15px; border-right: 4px solid #0ea5a4;">
                <h3 style="margin-bottom: 15px; color: #0a58ca;">خدمات اصلی ما:</h3>
                <ul style="list-style: none; padding: 0;">
                    <li style="margin-bottom: 10px;">✅ چاپ و پرینت با کیفیت بالا</li>
                    <li style="margin-bottom: 10px;">✅ فروش کتاب‌های درسی و دانشگاهی</li>
                    <li style="margin-bottom: 10px;">✅ لوازم تحریر و اداری</li>
                    <li style="margin-bottom: 10px;">✅ خدمات عکاسی و ادیت</li>
                    <li style="margin-bottom: 10px;">✅ آموزش دیجیتال و کامپیوتر</li>
                    <li style="margin-bottom: 10px;">✅ طراحی وب و ویرایش ویدئو</li>
                </ul>
            </div>
        </div>
    </div>
