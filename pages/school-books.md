...
<section class="page-hero">
    ...
    <div class="page-description">
        <p>
            ...
            <br><br>
            ما مجموعه‌ای کامل از کتاب‌های درسی مستعمل و دست‌دوم مکتب، از صنف اول تا دوازدهم را که در حد نو و با کیفیت عالی هستند، با پایین‌ترین نرخ ممکن عرضه می‌کنیم. فروش کتاب‌ها به‌صورت عمده و پرچون انجام می‌شود. در کنار خرید و فروش، مبادله (تعویض) کتاب‌های مستعمل و دست‌دوم نیز پذیرفته می‌شود.
            <br><br>
