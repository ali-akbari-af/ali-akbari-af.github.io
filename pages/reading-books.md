...
<section class="page-hero animate-fade-in-up">
    ...
    <div class="page-description">
        <p>
            ...
            <br><br>
            ما مجموعه‌ای گسترده از کتاب‌های مطالعاتی ارائه می‌کنیم، شامل کتاب‌های تاریخی، دانشگاهی، علمی، انگیزشی، روان‌شناسی، دینی، کتاب کودک و نوجوان و سایر مضامین رایج در جامعه. اکثر این کتاب‌ها مستعمل و دست‌دوم اما سالم و در حد نو هستند و با پایین‌ترین و نازل‌ترین قیمت ممکن به فروش می‌رسند. به عنوان مثال، قیمت‌هایی که معمولاً حدود ۳۰۰ افغانی است، در اینجا از ۵۰ افغانی به پایین عرضه می‌شود و فروش به صورت لیلام انجام می‌گیرد.
            <br><br>
            ...
            <br><br>
            با ما، کتاب‌های متنوع و مفید با کیفیت مناسب و قیمت استثنایی همیشه در دسترس شماست. در کنار خرید و فروش، مبادله (تعویض) کتاب‌های مستعمل و دست‌دوم نیز پذیرفته می‌شود.
        </p>
    </div>
</section>
...
<section class="philosophy-section">
    ...
    <div class="philosophy-content">
        ...
        <p>
            کتاب‌های ارائه شده در این بخش اکثراً مستعمل و دست‌دوم اما در شرایط کاملاً سالم هستند.
