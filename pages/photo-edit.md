...
<section class="page-hero">
    ...
    <div class="page-description">
        ...
        <p style="margin-top: 2rem; font-style: italic; color: var(--primary-dark);">
            ما با مهارت تخصصی و امکانات مدرن، آماده ارائه خدمات با کیفیت بالا و مطابق دقیق با خواسته‌های شما هستیم.
        </p>
    </div>
</section>
...
<section class="features-section">
    ...
    <div class="features-grid">
        ...
        <div class="feature-card">
            ...
            <h3 class="feature-title">تکنولوژی پیشرفته</h3>
            <p class="feature-description">ویرایش عکس‌ها با الگوریتم‌های هوشمند و کیفیت بی‌نقص.</p>
        </div>
