...
.gallery-section::before {
    ...
    right: 0;
    bottom: 0;
    background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" opacity="0.05"><path d="M20,20 L80,20 L80,80 L20,80 Z" fill="none" stroke="white" stroke-width="2"/><circle cx="50" cy="50" r="15" fill="none" stroke="white" stroke-width="2"/></svg>');
...
.showreel-placeholder {
    background: linear-gradient(45deg, #2a1a3a, #1a1a3a);
    aspect-ratio: 16/9;
    display: flex;
...
.showreel-placeholder::before {
    ...
    right: 0;
    bottom: 0;
    background: linear-gradient(45deg, rgba(255, 77, 141, 0.3), rgba(108, 99, 255, 0.3));
    z-index: 1;
}
...
.play-button {
    ...
    box-shadow: 0 0 50px rgba(255, 77, 141, 0.8);
    z-index: 2;
    animation: pulse 2s infinite;
    margin-bottom: 1rem;
}
...
<!-- بخش نمایش ریل (Showreel) -->
<section class="gallery-section">
    <div class="section-title">
        <h2>نمونه‌کارهای حرفه‌ای</h2>
        <p>با کیفیت، خلاقیت و توجه به جزئیات</p>
    </div>
    ...
    <div class="showreel-container">
        <div class="showreel-placeholder">
            ...
            <div class="showreel-text">مشاهده شوریل</div>
        </div>
    </div>
