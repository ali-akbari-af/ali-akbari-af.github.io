---
layout: page
title: "کتاب‌های انگلیسی - کتاب‌های درسی و آموزش زبان | فروشگاه علی اکبری کابل"
description: "کتاب‌های انگلیسی للمکاتب ومراكز التدريب – مجموعات شاملة لجميع المستويات مع الملفات الصوتية. أرخص الأسعار مع أعلى جودة وسرعة في التسويق في کابل."
keywords: "کتاب انگلیسی, کتاب زبان انگلیسی, کتاب‌های آموزشی انگلیسی, مكاتب کابل, مراكز تدريبية, کتاب‌فروشی علی اکبری"
...
<section class="page-hero">
    ...
    <div class="page-description">
        <p>
            ...
            <br><br>
            ما مجموعه‌ای کامل از کتاب‌های زبان انگلیسی مستعمل و دست‌دوم را برای مکاتب و مراکز آموزشی افغانستان عرضه می‌کنیم، شامل تمامی سطوح و رشته‌ها، از پایه تا پیشرفته، با سری‌ها از شماره اول تا آخر و همراه با فایل‌های صوتی آموزشی. این کتاب‌ها در حد نو و با کیفیت عالی هستند و فروش آن‌ها به صورت عمده و پرچون انجام می‌شود. در کنار خرید و فروش، مبادله (تعویض) کتاب‌های مستعمل و دست‌دوم نیز پذیرفته می‌شود.
            <br><br>
...
<section class="features-section">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3 class="feature-title">مجموعه کامل</h3>
