...
<section class="page-hero">
    ...
    <div class="page-description">
        <p>
            ...
            <br><br>
            ما مجموعه‌ای کامل از کتاب‌های زبان انگلیسی مستعمل و دست‌دوم را برای مکاتب و مراکز آموزشی افغانستان عرضه می‌کنیم، شامل تمامی سطوح و رشته‌ها، از پایه تا پیشرفته، با سری‌ها از شماره اول تا آخر و همراه با فایل‌های صوتی آموزشی. این کتاب‌ها در حد نو و با کیفیت عالی هستند و فروش آن‌ها به صورت عمده و پرچون انجام می‌شود.
            <br><br>
